					...
					<div class="col-lg-8">
                        <div class="row">
							...
							<?php 
								...
								$location=$_REQUEST['id'];
								$query=mysqli_query($con,"SELECT products.*, user.uname,user.utype,user.uimage FROM `products`,`user` WHERE products.uid=user.uid and location='$location'");
