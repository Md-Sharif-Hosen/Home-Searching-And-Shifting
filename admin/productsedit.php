...
if(isset($_POST['add']))
{
	...
	move_uploaded_file($temp_name,"products/$aimage");
	move_uploaded_file($temp_name1,"products/$aimage1");
	move_uploaded_file($temp_name2,"products/$aimage2");
	
	
	$sql = "UPDATE products SET title= '{$title}', pcontent= '{$content}', type='{$ptype}', stype='{$stype}', price='{$price}', location='{$loc}', city='{$city}', country='{$country}', 
	...
	if($result == true)
	{
		...
		header("Location:productsview.php?msg=$msg");
	}
	else{
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Update Products Details</h4>
									<?php echo $error; ?>
									<?php echo $msg; ?>
								</div>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="products/<?php echo $row['9'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="products/<?php echo $row['10'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="products/<?php echo $row['11'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="uid" required value="<?php echo $row['12']; ?>">
													</div>
												</div>
											</div>
										</div>
