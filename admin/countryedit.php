...
if(isset($_POST['insert']))
{
	...
	$sql="UPDATE country SET sname = '{$ucountry}'  WHERE sid = {$sid}";
	$result=mysqli_query($con,$sql);
	if($result)
		{
			$msg="<p class='alert alert-success'>country Updated</p>";
			header("Location:countryadd.php?msg=$msg");
		}
		else
		{
			$msg="<p class='alert alert-warning'>country Not Updated</p>";
			header("Location:countryadd.php?msg=$msg");
		}	
}
?>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<?php 
								$sid = $_GET['id'];
								$sql = "SELECT * FROM country where sid = {$sid}";
								$result = mysqli_query($con, $sql);
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group row">
														...
														<div class="col-lg-9">
															<input type="text" class="form-control" name="ucountry" value="<?php echo $row['1']; ?>">
														</div>
													</div>
												</div>
											</div>
