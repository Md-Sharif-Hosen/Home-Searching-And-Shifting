...
<!-- Meta Tags -->
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Home Seaching And Shifting">
    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Filter Products</b></h2>
                    </div>
                    <div class="col-md-6">
					...
					<div class="col-lg-8">
                        <div class="row">
							...
							if(isset($_REQUEST['filter']))
							{
								...
								$sql="SELECT products.*, user.uname FROM `products`,`user` WHERE products.uid=user.uid and type='{$type}' and stype='{$stype}' and city='{$city}'";
								//SELECT * FROM `products` WHERE type='office' or type='office' and stype='sale' or stype='rent' and city='valsad' OR state='mumbai'
								//SELECT * FROM `products` WHERE type='office' and stype='sale'  and city='valsad' OR state='mumbai'
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        <div class="p-4">
                                            <h5 class="text-secondary hover-text-success mb-2 text-capitalize"><a href="productsdetails.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h5>
                            ...
                            <?php 		
									...
									echo "<h1 class='mb-5'><center>No Products Available</center></h1>";
								}
